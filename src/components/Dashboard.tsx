...
export function Dashboard({
  ...
  const downloadStats = {
    ...
    categories: [
      ...new Set(downloadedDatasets.map((d) => d.category)),
    ].length,
  };
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Kelola dataset dan permintaan data Anda
        </p>
      </div>
            ...
            {downloadedDatasets.length === 0 ? (
              <div className="p-12 text-center">
                ...
                <p className="text-gray-500 mb-2">
                  Belum ada dataset yang didownload
                </p>
              ...
              downloadedDatasets.map((dataset) => (
                <div
                  key={`downloaded-${dataset.id}-${dataset.downloadedAt.getTime()}`}
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-4 flex items-center gap-2">
                        <span className="text-sm text-gray-600">
                          Format yang didownload:
                        </span>
                        <div className="flex gap-1">
                          {dataset.downloadedFormats.map(
                            (fmt) => (
                              <span
                                key={fmt}
          ...
          <div className="divide-y divide-gray-200">
            {requests.length === 0 ? (
              <div className="p-12 text-center">
                ...
                <p className="text-sm text-gray-400">
                  Gunakan chatbot untuk mengajukan permintaan
                  data baru
                </p>
              </div>
            ) : (
                  ...
                  >
                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex items-start gap-3 mb-3">
                          <span
                            className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-sm ${statusConfig.bgColor} ${statusConfig.textColor}`}
                          >
